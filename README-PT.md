...
**TTDAIU** é uma ferramenta de automação em shell script que configura sistemas Ubuntu após a instalação. Suporta Ubuntu 22.04 (Jammy), 24.04 (Noble) e 26.04 (Resolute) com dois perfis de execução — `base` para o essencial e `full` para uma estação de desenvolvimento completa.
